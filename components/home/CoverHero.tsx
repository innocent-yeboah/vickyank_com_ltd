...
export default function CoverHero() {
  return (
    <section className="relative flex min-h-[100svh] items-end overflow-hidden bg-navy-cover">
      ...
      <div
        aria-hidden="true"
        className="absolute inset-0 bg-gradient-to-t from-navy-cover/75 from-[8%] via-navy-cover/20 to-transparent"
      />
      <div
        aria-hidden="true"
        className="absolute inset-y-0 left-0 w-full bg-gradient-to-r from-navy-cover/40 via-navy-cover/10 to-transparent sm:w-1/2 lg:w-[38%]"
      />
      <div
        aria-hidden="true"
        className="absolute inset-x-0 top-0 h-24 bg-gradient-to-b from-navy-cover/25 to-transparent sm:h-32"
      />
