...
/**
 * Luxury-cars page film — the car reel that used to lead the home hero.
 * Muted, inline H.264 with still fallback for iOS and reduced motion.
 */
export default function LuxuryCarReel() {
    ...
    <div className="absolute inset-0 bg-navy-cover">
      <div className="absolute inset-0" aria-hidden="true">
        {showFilm ? (
          <video
            ref={videoRef}
            className="h-full w-full object-cover brightness-[1.12] contrast-[1.02]"
            src="/videos/luxury-cars.mp4"
            autoPlay
            muted
            loop
            playsInline
          ...
          <Image
            ...
            quality={95}
            sizes="100vw"
            className="object-cover object-[center_60%] brightness-[0.85] contrast-[1.02]"
          />
        )}
      </div>
